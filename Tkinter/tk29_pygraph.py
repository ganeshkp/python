...
class App:
    ...
    def initUI(self):
        ...
        tooltip.OnHoverTooltipBase(self.replot_button,
        ...
        tooltip.OnHoverTooltipBase(self.updateplot_button,
        ...
        tooltip.OnHoverTooltipBase(self.minima_button, 'Show local Minima')

        self.maxima_button = tk.Button(self.master, text='Local Maxima',
                                  command=self.maxima)
        self.maxima_button.grid(row=5, column=2)
        tooltip.OnHoverTooltipBase(self.maxima_button, 'Show local Maxima')
        ...
        tooltip.OnHoverTooltipBase(self.turning_button, 'Show turning points')

        self.tangent_button = tk.Button(self.master, text='Tangent',
                                        command=self.tangent)
        self.tangent_button.grid(row=6, column=3)
        tooltip.OnHoverTooltipBase(self.tangent_button, 'Show tangent at entered value')
