...
lucky_stars = data.iloc[:, 6:8].values
...
# Build Markov chains
main_transition_matrix = build_transition_matrix(main_numbers, 50)
lucky_transition_matrix = build_transition_matrix(lucky_stars, 12)
...
# Predict numbers
predicted_main = predict_markov(main_transition_matrix, 5, 50)
predicted_lucky = predict_markov(lucky_transition_matrix, 2, 12)
