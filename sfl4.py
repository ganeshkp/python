...
combination_size = 1  # You can change this to 3 for triplets, etc.
...
predicted_lucky_stars = [num for num, _ in lucky_star_number_counter.most_common(1)]

# Print the predicted numbers
print("Predicted Balls (1-47):", sorted(predicted_balls))
print("Predicted Lucky Stars (1-10):", sorted(predicted_lucky_stars))